                    ...
                    <div className="container d-flex flex-column justify-content-center align-items-center">
                        <div className="card p-4 shadow-lg bg-white rounded">
                            ...
                            <div className="text-center">
                                ...
                                <button href="" className="btn btn-outline-secondary" onClick={this.showRegisterPage}>Crie sua conta!</button>
                            </div>
                        </div>
                    </div>
                }
                {
                    ...
                    <div>
                        ...
                        <div className="text-center">
                            ...
                            <button href="" className="btn btn-outline-secondary" onClick={this.showLoginPage}>Voltar para tela de login!</button>
                        </div>
                    </div>
                }
            </>
